...
public class ClassView extends javax.swing.JPanel {
    ...
    public void showClass(List<ClassModel> models) {
        models.forEach(data -> {
            tb_data.AddJoModel(new Object[]{tb_data.autoNumber(), data.getClassID(), data.getClassName()});
        });
    ...
    private void initComponents() {
        ...
        btn_add.setText("ເພີ່ມຂໍ້ມູນຂະແໜງ");

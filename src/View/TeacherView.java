...
public class TeacherView extends javax.swing.JPanel {
    ...
    public int getID() {
        return Integer.parseInt(tb_data.getValue(1));
    }

    public void showTeacher(List<TeacherModel> teacher) {
    ...
    private void initComponents() {
        ...
        btn_Add.setText("ເພີ່ມຂໍ້ມູນອາຈານ");
        ...
        tb_data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "ID", "ເລກທີ່ພະນັກງານ", "ຊື່ ແລະ ນາມສະກູນ", "ເບີໂທ", "Facebook"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pn_dataTable, javax.swing.GroupLayout.DEFAULT_SIZE, 1115, Short.MAX_VALUE)
        );
